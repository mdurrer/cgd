{procedura vycházející z ListBoxu, která umožní listovat po seznamu
 ...
 bude ve videostránce číslo 1), editace masky a mapy bude ve videostránce
 číslo 0, maska bude uložena ve videostránce číslo 3 a obrázek samotný bude
 v paměti, neboť tak to požaduje MakeObj}
...
const x:integer=0;
      ...
      hlavicka='Vyber si místnost a provedenou akci';
      paticka='nápověda k akcím je dole';
      nap1='    Esc=konec; Ent=editace; Ins=nová; Del=smazání';
      nap2='        Tab=prohlédni pozadí; S=masky; P=mapy';
